#kde
pacman -S --needed plasma plasma-wayland-session plasma-wayland-protocols sddm ark dolphin konsole okular galculator kate spectacle packagekit-qt5 packagekit-qt6 kdialog print-manager system-config-printer ksystemlog partitionmanager kamoso gwenview --noconfirm
...
#utilities
pacman -S --needed papirus-icon-theme curl neofetch rust wget linux-lts-headers bash-completion sof-firmware appstream mlocate unrar unzip p7zip fuse ffmpeg pipewire wireplumber pipewire-audio pipewire-alsa pipewire-pulse --noconfirm
