...
# apps & utilities
apt install tlp vim htop neofetch timeshift unrar net-tools curl apt-transport-https apt-file mousepad redshift transmission-gtk nitrogen shotwell galculator firefox-esr plymouth-themes wmctrl libnotify-bin -y
...
flatpak install flathub org.gtk.Gtk3theme.Adwaita-dark org.libreoffice.LibreOffice org.flameshot.Flameshot org.gnome.Cheese com.github.maoschanz.drawing org.gimp.GIMP -y
