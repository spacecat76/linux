...
# desktop environment
apt install i3 polybar picom slick-greeter thunar thunar-archive-plugin lxterminal xfce4-screenshooter mousepad redshift transmission-gtk nitrogen gnome-keyring shotwell galculator light xbindkeys gvfs-backends ffmpegthumbnailer tumbler tumbler-plugins-extra upower xss-lock lm-sensors gtk2-engines-pixbuf firefox-esr -y
