...
# applications
pacman -S --needed firefox vim nano vlc htop fastfetch timeshift podman distrobox starship --noconfirm
systemctl enable cronie
usermod --add-subuids 100000-165535 --add-subgids 100000-165535 fabri

# utilities
pacman -S --needed fwupd speech-dispatcher curl neofetch rust wget bash-completion sof-firmware appstream mlocate unrar unzip p7zip fuse2 ffmpeg ffmpegthumbs ffmpegthumbnailer gst-libav gst-plugins-ugly dnsutils --noconfirm

# flatpak
pacman -S --needed flatpak --noconfirm
flatpak remote-add --if-not-exists --user flathub https://dl.flathub.org/repo/flathub.flatpakrepo
flatpak install --system flathub org.onlyoffice.desktopeditors com.brave.Browser org.gimp.GIMP com.system76.Popsicle com.github.tchx84.Flatseal com.transmissionbt.Transmission com.mattjakeman.ExtensionManager com.spotify.Client -y
