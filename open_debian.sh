...
# desktop environment
apt install lxterminal openbox polybar picom slick-greeter thunar thunar-archive-plugin seahorse light xbindkeys gvfs-backends ffmpegthumbnailer tumbler tumbler-plugins-extra upower xss-lock lm-sensors gtk2-engines-pixbuf dbus-x11 rofi policykit-1-gnome mousetweaks -y

# apps & utilities
apt install tlp gimp vim htop neofetch timeshift unrar net-tools curl apt-transport-https apt-file mousepad redshift transmission-gtk nitrogen shotwell galculator plymouth-themes wmctrl libnotify-bin -y
...
flatpak install flathub org.gtk.Gtk3theme.Adwaita-dark org.libreoffice.LibreOffice org.flameshot.Flameshot org.mozilla.firefox -y
