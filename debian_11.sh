...
# apps & utilities
apt install tlp vim htop neofetch timeshift unrar papirus-icon-theme net-tools curl build-essential apt-transport-https python3-pip mlocate ffmpeg libavcodec-extra gstreamer1.0-libav gstreamer1.0-vaapi gstreamer1.0-plugins-ugly apt-file gimp -y
