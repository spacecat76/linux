...
pacman -S --needed gnome-shell gdm gnome-control-center gnome-terminal gnome-software gnome-software-packagekit-plugin file-roller gedit nautilus gnome-tweaks nano firefox sane cups nss-mdns vlc htop curl vim cheese gnome-calculator gnome-photos totem gnome-screenshot gnome-logs gnome-system-monitor evince transmission-gtk simple-scan libreoffice tlp net-tools linux-firmware chromium base-devel ufw fuse gutenprint neofetch rust wget virtualbox gnome-keyring linux-headers --noconfirm
