...
# desktop environment
apt install gnome-core gnome-weather gnome-calendar gnome-clocks gnome-screenshot gnome-tweaks file-roller transmission-gtk shotwell cheese -y

# apps & utilities
apt install gimp vim htop neofetch timeshift unrar net-tools curl build-essential apt-transport-https apt-file -y
