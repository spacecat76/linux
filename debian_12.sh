...
# apps & utilities
apt install gimp vim htop neofetch timeshift unrar net-tools curl build-essential apt-transport-https apt-file lm-sensors plymouth-themes cockpit cockpit-machines virt-viewer -y
...
flatpak install flathub org.gtk.Gtk3theme.Adwaita-dark com.system76.Popsicle org.libreoffice.LibreOffice io.gitlab.librewolf-community com.github.tchx84.Flatseal org.mozilla.firefox -y
